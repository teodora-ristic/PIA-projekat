...
export class ProfilComponent implements OnInit{
  ...
  azuriraj() {
    ...
    if (this.brKartice=="") {
      this.brKartice=this.ulogovan.brKartice;
    }
    this.userService.azuriraj(this.ulogovan.korisnickoIme,this.ime,this.prezime,this.adresa,this.mejl,this.telefon,this.brKartice).subscribe((resp) => {
      this.ime = "";
      this.prezime = "";
      this.adresa = "";
      this.mejl = "";
